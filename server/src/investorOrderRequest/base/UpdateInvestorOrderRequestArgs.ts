...
@ArgsType()
class UpdateInvestorOrderRequestArgs {
  @Field(() => InvestorOrderRequestWhereUniqueInput, { nullable: false })
  where!: InvestorOrderRequestWhereUniqueInput;
  @Field(() => InvestorOrderRequestUpdateInput, { nullable: false })
  data!: InvestorOrderRequestUpdateInput;
}

export { UpdateInvestorOrderRequestArgs };
